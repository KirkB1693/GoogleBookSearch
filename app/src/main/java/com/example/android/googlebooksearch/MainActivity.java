...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Book>> {
    ...
    private static final String GOOGLE_BOOKS_URL_END = "&filter=free-ebooks&maxResults=5&prettyPrint=false";
    ...
    public void searchForBooks (View view) {
        ...
        EditText search_input_field = findViewById(R.id.book_search_input);
